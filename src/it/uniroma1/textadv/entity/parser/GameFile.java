package it.uniroma1.textadv.entity.parser;

import it.uniroma1.textadv.entity.factory.EntityProcessor;
...
public class GameFile implements Iterable<GameFile.Section> {
    ...
    public static class Line {
        ...
        public Stream<String> getSeparatedArguments() {
            return getStringArgument(TAB_SEPARATED_ARG_MAPPER);
        }
        ...
        public Stream<String> getCommaSeparatedArguments() {
            return getStringArgument(COMMA_SEPARATED_ARG_MAPPER);
        }
         ...
         */
        public Stream<String> getStringArgument(Function<String, Stream<String>> mapper) {
            return mapper.apply(getArgumentsString()).map(String::trim);
        }
         ...
         * @param mapper Funzione di trasformazione degli argomenti,
         *               forniti come stringa raw.
         * @param <R>    Tipo finale del risultato
         * @return Argomenti della linea, trasformati in base alla funzione
         * @see Line#getArgumentsString()
         */
     ...
     *
     * @see EntityProcessor.BuildContext.DependencyException
     */
